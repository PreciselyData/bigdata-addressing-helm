...
docker tag geo-addressing-spark-on-k8s:latest [AWS-ACCOUNT-ID].dkr.ecr.[REGION].amazonaws.com/geo-addressing-spark-on-k8s:1.0.1
docker push [AWS-ACCOUNT-ID].dkr.ecr.[REGION].amazonaws.com/geo-addressing-spark-on-k8s:1.0.1
```
